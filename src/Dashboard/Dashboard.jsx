...
const Dashboard = () => {
    ...
    return (
        <main className="nunito_sans">
            <Helmet>
                <title>Doc House | Dashboard</title>
            </Helmet>
            <ToastContainer/>
                ...
                <div className={` lg:block w-full lg:w-2/12 ${isSidebarOpen ? 'block' : 'hidden'}`}>
                    <div className="bg-[#FFFFFF] sidemenu h-full sticky top-0 -mt-5 list-none ">
                        ...
                        <li className="-mt-[14px] mb-5">
                            <NavLink to="dashboardhome" className="flex items-center gap-[7px] hover:bg-[#F1F5F9] py-5 px-3  transition-none text-[#898989] hover:text-[#122033]  transition-all delay-100 font-[700]">
                        ...
                        <li className="-mt-[14px]  mb-5">
                            <NavLink to="adddoctor" className="flex items-center gap-[7px] hover:bg-[#F1F5F9] py-5 px-3  transition-none text-[#898989] hover:text-[#122033] transition-all delay-100 font-[700]">
                                <FaUserDoctor className="text-[23px]" />
                                <p className="text-[16px]"> Add a Doctor</p>
                            </NavLink>
                        </li>

                        <li className="-mt-[14px]  mb-5">
                            <NavLink to="managedoctor" className="flex items-center gap-[7px] hover:bg-[#F1F5F9] py-5 px-3  transition-none text-[#898989] hover:text-[#122033] transition-all delay-100 font-[700]">
                                <FaUserDoctor  className="text-[23px]" />
                                <p className="text-[16px]"> Manage Doctors</p>
                            </NavLink>
                        </li>
